...
| Method | Path                     | Purpose                 | Required permission |
| ------ | ------------------------ | ----------------------- | ------------------- |
| GET    | /salaries/summary/salary | Get salary summary list | employees:read      |
| POST   | /salaries                | Create salary record    | employees:manage    |
| PATCH  | /salaries/:id            | Update salary fields    | employees:manage    |
