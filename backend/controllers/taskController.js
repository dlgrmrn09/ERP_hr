...
export const createWorkspace = asyncHandler(async (req, res) => {
  ...
  res.status(201).json({ workspace: workspace.rows[0] });
});
...
export const updateWorkspace = asyncHandler(async (req, res) => {
  ...
  res.json({ workspace: workspace.rows[0] });
});
...
export const createBoard = asyncHandler(async (req, res) => {
  ...
  res.status(201).json({ board: board.rows[0] });
});
...
export const createStatusGroup = asyncHandler(async (req, res) => {
  ...
  res.status(201).json({ statusGroup: insertResult.rows[0] });
});
...
export const updateStatusGroup = asyncHandler(async (req, res) => {
  ...
  res.json({ statusGroup: result.rows[0] });
});
